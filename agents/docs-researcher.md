...
use docs at `doc.rust-lang.org/std/` instead.

## URL Format

`docs.rs/<crate>/latest/<crate>/<path>`

Examples:

- Struct: `docs.rs/tokio/latest/tokio/sync/struct.Mutex.html`
- Trait: `docs.rs/serde/latest/serde/trait.Serialize.html`
- Function: `docs.rs/rand/latest/rand/fn.random.html`
...
`docs.rs/<crate>/<version>/` instead of `/latest/`.
